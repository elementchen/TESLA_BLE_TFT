...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "0.4.9.1"
  WORKING_DIRECTORY "E:/AI_coding_test/_Gemini/TESLA_BLE_TFT/build/_deps/nanopb-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/AI_coding_test/_Gemini/TESLA_BLE_TFT/build/_deps/nanopb-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/AI_coding_test/_Gemini/TESLA_BLE_TFT/build/_deps/nanopb-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
